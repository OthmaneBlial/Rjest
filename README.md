...
![Differential scenarios](https://img.shields.io/badge/differential_scenarios-174%2F174-c8ff3d?style=flat-square)
...
| --- | ---: | ---: |
| Versioned differential matrix | 174 / 174 scenarios | 174 / 174 scenarios |
...
The 174/174 result is **100% of the versioned scenarios currently in the
...
- Dependency-aware `--watch`, interactive watch controls/plugins, and V8
  coverage are not implemented. Native `--watchAll` is available.
