...
const cases = [
  ...
  {
    name: 'config-wait-unhandled-rejections',
    category: 'Configuration',
    expectedExit: 0,
    testPathPatterns: ['handled-later.test.cjs'],
    useFixtureConfig: true,
  },
  {
    name: 'config-wait-unhandled-rejections',
    label: 'config-wait-unhandled-rejections-failure',
    category: 'Configuration',
    expectedExit: 1,
    testPathPatterns: ['unhandled.test.cjs'],
    useFixtureConfig: true,
  },
  {
    name: 'config-wait-unhandled-rejections',
    label: 'config-wait-unhandled-rejections-hooks',
    category: 'Configuration',
    expectedExit: 0,
    testPathPatterns: ['handled-hooks.test.cjs'],
    useFixtureConfig: true,
  },
  {
    name: 'config-wait-unhandled-rejections',
    label: 'config-wait-unhandled-rejections-before-all-failure',
    category: 'Configuration',
    expectedExit: 1,
    testPathPatterns: ['unhandled-before-all.test.cjs'],
    useFixtureConfig: true,
  },
  {
    name: 'config-wait-unhandled-rejections',
    label: 'config-wait-unhandled-rejections-after-all-failure',
    category: 'Configuration',
    expectedExit: 1,
    testPathPatterns: ['unhandled-after-all.test.cjs'],
    useFixtureConfig: true,
  },
  {
    name: 'config-no-wait-unhandled-rejections',
    category: 'Configuration',
    expectedExit: 1,
    useFixtureConfig: true,
  },
