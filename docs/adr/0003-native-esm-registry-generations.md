...
- A future isolated registry can activate a unique generation temporarily and
  restore the outer generation afterward; `isolateModulesAsync` remains a
  separately measured compatibility gap until that lifecycle is implemented.
