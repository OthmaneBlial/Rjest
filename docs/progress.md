...
- An automated differential denominator containing executable compatibility
  probes. The current generated result is 229/229 compatible scenarios (100.0%),
  with Core API at 15/15 (100.0%), ESM at 8/8
...
entries. The current probe corpus score is 229/229 (100.0%). Core API is 15/15
(100.0%), ESM is 8/8
