...
- An automated differential denominator containing executable compatibility
  probes. The current generated result is 140/140 compatible scenarios (100.0%),
  with Core API at 13/13 (100.0%), ESM at 8/8
  (100.0%), transforms at 7/7 (100.0%), mocks at 14/14 (100.0%), configuration
  at 32/32 (100.0%), snapshots at 14/14 (100.0%), CLI at 13/13 (100.0%),
...
entries. The current probe corpus score is 140/140 (100.0%). Core API is 13/13
(100.0%), ESM is 8/8
(100.0%), transforms are 7/7 (100.0%), mocks are 14/14 (100.0%), configuration
is 32/32 (100.0%), CLI is 13/13 (100.0%), resolution is 12/12 (100.0%), snapshots
...
- Inline-object and string/path-glob entries in Jest `projects` are normalized
  ...
  are covered, as are configured custom-sequencer sort, shard, and cache
  lifecycles. Multi-project coverage, default persisted performance ordering,
  `--onlyFailures`/`allFailedTests`, custom-resolver sequencer lookup,
...
4. Expand multi-project coverage, custom-sequencer only-failure/custom-resolver,
