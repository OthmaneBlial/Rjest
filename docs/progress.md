...
- An automated differential denominator containing executable compatibility
  probes. The current generated result is 202/202 compatible scenarios (100.0%),
  ...
  environments at 7/7 (100.0%), coverage at 15/15 (100.0%), reporters at 6/6
...
entries. The current probe corpus score is 202/202 (100.0%). Core API is 13/13
(100.0%), ESM is 8/8
...
10/10 (100.0%), reporters are 6/6 (100.0%), and Watch is 4/4 (100.0%).
...
- Inline-object and string/path-glob entries in Jest `projects` are normalized
  ...
  transform and discovery caches, live reporter case-event timing, specialized
  built-in reporters, and broader platform-specific glob edges remain
...
5. Stream test-case reporter events during worker execution and broaden
