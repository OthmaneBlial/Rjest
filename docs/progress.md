...
- An automated differential denominator containing executable compatibility
  probes. The current generated result is 123/123 compatible scenarios (100.0%),
...
entries. The current probe corpus score is 123/123 (100.0%). Core API is 13/13
(100.0%), ESM is 8/8
...
1. Run an independent Yarn PnP monorepo with zip-backed dependencies unchanged.
