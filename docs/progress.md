...
- An automated differential denominator containing executable compatibility
  probes. The current generated result is 117/117 compatible scenarios (100.0%),
...
- Apollo Client 4.2.12 is pinned as a current Jest 30, TypeScript, React
  ...
  The full 563-suite Rjest capture remains the current compatibility run.
...
entries. The current probe corpus score is 117/117 (100.0%). Core API is 11/11
(100.0%), ESM is 8/8
...
are 11/11 (100.0%), Expect is 6/6 (100.0%), environments are 7/7 (100.0%), and
coverage is 3/3 in
