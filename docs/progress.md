...
- An automated differential denominator containing executable compatibility
  probes. The current generated result is 226/226 compatible scenarios (100.0%),
  with Core API at 14/14 (100.0%), ESM at 8/8
...
entries. The current probe corpus score is 226/226 (100.0%). Core API is 14/14
(100.0%), ESM is 8/8
