...
- An automated differential denominator containing executable compatibility
  probes. The current generated result is 121/121 compatible scenarios (100.0%),
...
- Apollo Client 4.2.12 is pinned as a current Jest 30, TypeScript, React
  ...
  skipped. The full 563-suite Rjest capture remains the current compatibility
  run.
...
entries. The current probe corpus score is 121/121 (100.0%). Core API is 13/13
(100.0%), ESM is 8/8
...
are 12/12 (100.0%), Expect is 7/7 (100.0%), environments are 7/7 (100.0%), and
coverage is 3/3 in
