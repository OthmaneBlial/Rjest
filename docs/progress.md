...
- An automated differential denominator containing executable compatibility
  probes. The current generated result is 173/173 compatible scenarios (100.0%),
...
entries. The current probe corpus score is 173/173 (100.0%). Core API is 13/13
(100.0%), ESM is 8/8
...
10/10 (100.0%), and reporters are 6/6 (100.0%).
...
4. Stream test-case reporter events during worker execution and expand
