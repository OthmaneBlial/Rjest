...
- An automated differential denominator containing executable compatibility
  probes. The current generated result is 132/132 compatible scenarios (100.0%),
  with Core API at 13/13 (100.0%), ESM at 8/8
  (100.0%), transforms at 7/7 (100.0%), mocks at 14/14 (100.0%), configuration
  at 30/30 (100.0%), snapshots at 14/14 (100.0%), CLI at 7/7 (100.0%),
...
entries. The current probe corpus score is 132/132 (100.0%). Core API is 13/13
(100.0%), ESM is 8/8
(100.0%), transforms are 7/7 (100.0%), mocks are 14/14 (100.0%), configuration
is 30/30 (100.0%), CLI is 7/7 (100.0%), resolution is 12/12 (100.0%), snapshots
...
- `--projects` loads multiple CLI project paths, but display-name filtering
  through `--selectProjects` and `--ignoreProjects` remains unsupported.
