...
- An automated differential denominator containing executable compatibility
  probes. The current generated result is 128/128 compatible scenarios (100.0%),
  with Core API at 13/13 (100.0%), ESM at 8/8
  (100.0%), transforms at 5/5 (100.0%), mocks at 14/14 (100.0%), configuration
  at 29/29 (100.0%), snapshots at 14/14 (100.0%), CLI at 6/6 (100.0%),
...
entries. The current probe corpus score is 128/128 (100.0%). Core API is 13/13
(100.0%), ESM is 8/8
(100.0%), transforms are 5/5 (100.0%), mocks are 14/14 (100.0%), configuration
is 29/29 (100.0%), CLI is 6/6 (100.0%), resolution is 12/12 (100.0%), snapshots
...
- Synchronous, async-only, and disagreeing dual-hook custom resolvers work
  ...
  React Native resolver are covered separately. A pnpm hoisted workspace is
  covered by styled-components; strict isolated-linker layouts, the rest of the
  current Jest resolver option surface, other PnP fallback modes, and broader
