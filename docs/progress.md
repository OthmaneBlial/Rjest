...
- An automated differential denominator containing executable compatibility
  probes. The current generated result is 203/203 compatible scenarios (100.0%),
  ...
  environments at 7/7 (100.0%), coverage at 15/15 (100.0%), reporters at 7/7
...
entries. The current probe corpus score is 203/203 (100.0%). Core API is 13/13
(100.0%), ESM is 8/8
...
coverage is 15/15 (100.0%) in their bounded scenario categories. Fake timers are
...
- V8 coverage, watch plugins, Mercurial/Sapling changed-file selection, exact
  custom-environment VM-context identity, worker
